...
def build(bld):
    core_sources = ['external/lua-5.2.2/src/lapi.c',
    ...
    lib_sources = ['external/lua-5.2.2/src/lauxlib.c',
    ...
    lua_sources = ['external/lua-5.2.2/src/lua.c']
    luac_sources = ['external/lua-5.2.2/src/luac.c']
    ...
    bld(
        ...
        source = wrap_sources,
        use = 'luaobjs',
        includes = 'external/lua-5.2.2/src',
        target = 'wrapobjs')
